...
- Shin, M. (2026). *pubmlp: Multimodal publication classifier with LLM and deep learning* (Python package version 0.3.2) [Computer software]. <https://github.com/mshin77/pubmlp>
