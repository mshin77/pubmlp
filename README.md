...
- Shin, M. (2026). *pubmlp: Multimodal publication classifier with LLM and deep learning* (Python package version 0.2.5) [Computer software]. <https://github.com/mshin77/pubmlp>
